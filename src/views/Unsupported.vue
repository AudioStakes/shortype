...
<template>
  <div class="w-screen h-screen absolute">
    <div class="w-screen h-screen bg-black opacity-30 top-0" @click="proceed"></div>
    <div
          ...
          <ul>
            <li class="flex my-0.5">
              <div class="h-6 w-6 min-h-[1.4rem] min-w-[1.4rem] mx-2">
                <XCircleIcon v-if="isUnsupportedBrowser" class="text-red-400 inline-block" />
            ...
            <li class="flex my-0.5">
              <div class="h-6 w-6 min-h-[1.4rem] min-w-[1.4rem] mx-2">
                <XCircleIcon v-if="isUnsupportedOs" class="text-red-400 inline-block" />
                <CheckCircleIcon v-else class="text-green-400 inline-block" />
              </div>
              <div>
                OSは
